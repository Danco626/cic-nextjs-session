              ...
              {user && (
                <UncontrolledDropdown nav inNavbar data-testid="navbar-menu-desktop">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownItem id="qsLogoutBtn">
                      <AnchorLink href="/api/auth/log-session" icon="power-off" testId="navbar-logout-desktop">
                        log-session
                      </AnchorLink>
                    </DropdownItem>
                    <DropdownItem id="qsLogoutBtn">
                      <AnchorLink href="/api/auth/login?mfa=true" icon="power-off" testId="navbar-logout-desktop">                      
                        Get MFA Token
                      </AnchorLink>
                    </DropdownItem>                    
